...
static inline vu8* const i2cGetDataReg(u8 bus_id) {
...
static inline vu8* const i2cGetCntReg(u8 bus_id) {
...
u32 i2cReadRegisterBuffer(unsigned int dev_id, int reg, u8* buffer, size_t buf_size) {
    u8 bus_id = i2cGetDeviceBusId(dev_id);
    u8 dev_addr = i2cGetDeviceRegAddr(dev_id);
